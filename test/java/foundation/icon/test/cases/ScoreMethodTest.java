...
public class ScoreMethodTest {
    private static final String SCORE_PATH = "method_caller";
    ...
    static void init() throws Exception {
        ...
        methodCaller = txHandler.deploy(owner, Score.getFilePath(SCORE_PATH), null);
    }
    ...
    public void callInternalsDirectly() throws Exception {
        ...
        txs.add(testScore.invoke(owner, "fallback", null, BigInteger.valueOf(100), Constants.DEFAULT_STEPS));
        LOG.infoExiting();
    ...
    public void checkInternalCalls() throws Exception {
        ...
        var dtx = txHandler.deployOnly(owner, Score.getFilePath(SCORE_PATH), null);
        ...
        dtx = txHandler.deployOnly(owner, new Address(score_addr), Score.getFilePath(SCORE_PATH), null);
    ...
    @Test
    void queryVariousMethods() throws Exception {
    ...
    public void callReadonlyMethods() throws Exception {
        ...
        LOG.info("case0"+" readonlyReturnInt");
