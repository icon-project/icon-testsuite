...
public class TokenScore {
    ...
    public TokenScore(IconService iconService, Address scoreAddress) {
    ...
    public RpcItem balanceOf(Address owner) throws IOException {
    ...
    public Bytes transfer(Wallet fromWallet, Address toAddress, String value) throws IOException {
        RpcObject params = new RpcObject.Builder()
